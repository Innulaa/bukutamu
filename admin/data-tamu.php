  ...
  <header class="bg-white py-4 px-6 shadow flex justify-between items-center fixed top-0 left-64 right-0 z-40">
    ...
    <div id="profileBtn" class="flex items-center gap-2 cursor-pointer relative">
      ...
      <div id="dropdownProfile" class="absolute right-0 mt-12 w-48 bg-white rounded shadow-lg hidden">
        <a href="#" class="block px-4 py-2 text-sm hover:bg-orange-100">Profil</a>
        <a href="#" class="block px-4 py-2 text-sm hover:bg-orange-100">Ganti Password</a>
        <a href="#" class="block px-4 py-2 text-sm hover:bg-orange-100">Setting</a>
        <a href="#" class="block px-4 py-2 text-sm text-red-600 hover:bg-orange-100">Logout</a>
      </div>
    </div>
  </header>
